...
export default function MotionServiciosDetallados() {
  return (
    ...
    >
      ...
      <div className="container mx-auto px-8 sm:px-12 lg:px-16 relative z-10" style={{paddingLeft: '100px', paddingRight: '100px', outline: '2px dashed red', outlineOffset: '5px'}}>
        {/* Section Badge */}
